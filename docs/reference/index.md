...
PyFAME's API is broken down into several submodules containing core features
(analyse, file_access, landmark, layer) and helpful utilities (logging, utils). Use the
quick access links below or the side bar to navigate to a specific submodule:
...
-   :material-map-marker-radius:{ .lg .middle } **Landmark**
    ...
    Facial landmark definitions and region mappings used throughout PyFAME.

    [:octicons-arrow-right-24: Reference](./landmark.md)

-   :material-layers-outline:{ .lg .middle } **Layer**

    ---

    Facial manipulation layers for colour, masking, overlays, spatial transformations, and stylisation.
...
-   :material-text-box-outline:{ .lg .middle } **Logging**
    ...
    Logging utilities for recording PyFAME processing and manipulation information.
